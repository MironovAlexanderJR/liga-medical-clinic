...
public class RabbitConfig {
    ...
    public Queue getCommonMonitoringQueue() {
        return new Queue(QueueNames.COMMON_MONITORING_QUEUE);
    }

    @Bean("dailyQueue")
    public Queue getDailyQueue() {
        return new Queue(QueueNames.DAILY_QUEUE);
    }

    @Bean("alertQueue")
    public Queue getAlertQueue() {
        return new Queue(QueueNames.ALERT_QUEUE);
    }

    @Bean("errorQueue")
    public Queue getErrorQueue() {
        return new Queue(QueueNames.ERROR_QUEUE);
    }
}
